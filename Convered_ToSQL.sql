...
INSERT INTO s_customer VALUES (
   ...
   'EXCELLENT', 12, 2, CONCAT('Customer usually orders large amounts and has ' ,
...
INSERT INTO s_customer VALUES (
   ...
   'POOR', 14, 4, CONCAT('Customer should always pay by cash until his credit ' ,
   'rating improves.'));
INSERT INTO s_customer VALUES (
   203, 'Delhi Sports', '91-10351',
   '11368 Chanakya', 'New Delhi', NULL, 'India', NULL,
   'GOOD', 14, 4, CONCAT('Customer specializes in baseball equipment and is the ' ,
...
INSERT INTO s_customer VALUES (
   ...
   'EXCELLENT', 15, 5, CONCAT('Customer specializes in Soccer.  Likes to order ' ,
...
INSERT INTO s_customer VALUES (
   ...
   'GOOD', 15, 5, CONCAT('Customer usually pays small orders by cash and ' ,
...
INSERT INTO s_customer VALUES (
   ...
   'POOR', 15, 5, CONCAT('This customer is very friendly, but has difficulty ' ,
...
INSERT INTO s_longtext VALUES (
   1017, 'N', NULL, 
   CONCAT('Protective knee pads for any number of physical activities including ' ,
...
INSERT INTO s_longtext VALUES (
   1019, 'N', NULL, 
   CONCAT('Protective elbow pads for any number of physical activities including ' ,
   'bicycling and skating (4-wheel, in-line, and ice).  Also provide ' ,
   'support for stress activities such as weight-lifting.  Velcro belts ' ,
   'allow easy adjustment for any size and snugness of fit.  Hardened ' ,
   'plastic shell comes in a variety of colors, so you can buy a pair to ' ,
...
INSERT INTO s_longtext VALUES (
   1286, 'N', NULL, 
   CONCAT('Don''t slack off--try the Slaker Water Bottle.  With its 1 quart ' ,
...
INSERT INTO s_longtext VALUES (
   518, 'N', NULL, 
   CONCAT('Perfect for the beginner.  Rear entry (easy to put on with only one ' ,
   'buckle), weight control adjustment on side of boot for easy access, ' ,
   'comes in a wide variety of colors to match every outfit.'));
INSERT INTO s_longtext VALUES (
   519, 'N', NULL, 
   CONCAT('If you have mastered the basic techniques you are ready for the Ace Ski ' ,
...
INSERT INTO s_longtext VALUES (
   520, 'N', NULL, 
   CONCAT('The Pro ski boot is an advanced boot that combines high tech and ' ,
...
INSERT INTO s_longtext VALUES (
   528, 'N', NULL, 
   CONCAT('Lightweight aluminum pole, comes in a variety of sizes and neon ' ,
...
INSERT INTO s_longtext VALUES (
   933, 'N', NULL, 
   CONCAT('The widest, strongest, and knobbiest tires for mountain bike ' ,
